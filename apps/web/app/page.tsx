    ...
    <>
      ...
      <main id="main" tabIndex={-1} className="landing">
          ...
          <div className="cards">
            <article>
              ...
              <p>
                ...
                Subsurface XML for the enthusiasts.
              </p>
            </article>
            <article>
              <h3>Spreadsheets</h3>
              <p>
                CSV or a workbook, in whatever shape you built years ago. Columns are mapped once
                and the mapping is saved. Dates as serials, times as fractions, `N/A` for null — all
                of it expected.
              </p>
            </article>
            <article>
              ...
              <p>
                ...
                <code>-00:04</code> when it means −04:00, putting every dive four hours out. We
                detect it, correct it against the site&rsquo;s coordinates, and show you what
                changed.
              </p>
            </article>
          </div>
          <p className="footnote">
            Garmin FIT, Shearwater Cloud and vendor integrations come after launch. If a format is
            not listed, the generic spreadsheet importer usually still gets it in.
          </p>
        </section>
        ...
        <section id="trust" className="section">
          ...
          <div className="cards">
            ...
            <article>
              ...
              <p>
                No decompression planning, no no-fly timers, no in-water guidance of any kind. This
                is a records product and it stays one.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className="section cta">
          ...
          <p className="lede">
            That is the one worth trying. Nothing is written to your logbook until you have seen
            what the import proposes.
          </p>
          <a className="button primary" href={user ? '/logbook' : '/signin'}>
